            ...
            <c:if test="${authInfo.userid eq null}">
               ...
               <div class="row">
                  <form action="login.do" method="post" 
                     style="height: 150px;width: 600px;" class="col s12">

                     <div class="row" style="height: 30px;width: 1330px;margin-top: 60px;">
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<i class="fas fa-child fa-2x"></i>
                        &nbsp;&nbsp;
...
&nbsp;
            ...
            <c:if test="${authInfo.userid ne null}">            
                     ...
                     <form align="center" action="logout.do" method="post" style="height:70px;padding-top: 20px;">
                     ${authInfo.userid}님 환영합니다.
                  <button type="submit" class="btn btn-warning" action="logout.do" method="post">로그아웃</button>
