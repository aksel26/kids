...
>>>>>>> 0973b0718bee78d23becd40706cd175fd4c9e08c
...
function getiwContent(count,value){//인포 윈도우 얻어오기
    return  '<div class="wrap">' + 
			 ...
			 '				<a style="font-family: Hanna; text-align:center;" href="detail.do?kindername='+value["kindername"]+'&kinderinfoId='+value["kinderinfoId"]+'"/>'+'>>>상세보기'+
		     '            </div>' + 
		     '        </div>' + 
		     '    </div>' +    
		     '</div>';
